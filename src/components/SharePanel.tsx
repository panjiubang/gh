          ...
          >
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="hud-text text-[11px] text-[var(--text-primary)]">分享视图</span>
              </div>
            ...
            <div className="mb-3 p-2 rounded-lg bg-[var(--bg-void)] border border-[var(--border-primary)]">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-[9px] font-mono text-[var(--text-muted)] tracking-widest">当前视图</span>
              </div>
              ...
              <div className="text-[9px] font-mono text-[var(--text-muted)] mt-1">
                {Object.values(activeLayers).filter(Boolean).length} 个活动图层
              </div>
            </div>
            ...
            <div className="mb-3">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-[9px] font-mono text-[var(--text-muted)] tracking-widest">可分享链接</span>
              </div>
